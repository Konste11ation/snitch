...
package clint_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    clint_reg2hw_msip_mreg_t [8:0] msip; // [648:640]
    clint_reg2hw_mtimecmp_low0_reg_t mtimecmp_low0; // [639:608]
    clint_reg2hw_mtimecmp_high0_reg_t mtimecmp_high0; // [607:576]
    clint_reg2hw_mtimecmp_low1_reg_t mtimecmp_low1; // [575:544]
    clint_reg2hw_mtimecmp_high1_reg_t mtimecmp_high1; // [543:512]
    clint_reg2hw_mtimecmp_low2_reg_t mtimecmp_low2; // [511:480]
    clint_reg2hw_mtimecmp_high2_reg_t mtimecmp_high2; // [479:448]
    clint_reg2hw_mtimecmp_low3_reg_t mtimecmp_low3; // [447:416]
    clint_reg2hw_mtimecmp_high3_reg_t mtimecmp_high3; // [415:384]
    clint_reg2hw_mtimecmp_low4_reg_t mtimecmp_low4; // [383:352]
    clint_reg2hw_mtimecmp_high4_reg_t mtimecmp_high4; // [351:320]
    clint_reg2hw_mtimecmp_low5_reg_t mtimecmp_low5; // [319:288]
    clint_reg2hw_mtimecmp_high5_reg_t mtimecmp_high5; // [287:256]
    clint_reg2hw_mtimecmp_low6_reg_t mtimecmp_low6; // [255:224]
    clint_reg2hw_mtimecmp_high6_reg_t mtimecmp_high6; // [223:192]
    clint_reg2hw_mtimecmp_low7_reg_t mtimecmp_low7; // [191:160]
    clint_reg2hw_mtimecmp_high7_reg_t mtimecmp_high7; // [159:128]
    clint_reg2hw_mtimecmp_low8_reg_t mtimecmp_low8; // [127:96]
    clint_reg2hw_mtimecmp_high8_reg_t mtimecmp_high8; // [95:64]
  ...
  parameter logic [3:0] CLINT_PERMIT [21] = '{
    ...
    4'b 1111, // index[19] CLINT_MTIME_LOW
    4'b 1111  // index[20] CLINT_MTIME_HIGH
  };
