...
def emit_header_file(**kwargs):
    ...
    emit_str += emit_Cx_load_from_Cy(init_cluster=1,target_cluster=0,
                                    ...
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
    # C2 Loading In1 from Cluster0 : Again assume the Cluster has enough local memory to store the input 
    ...
    emit_str += emit_Cx_load_from_Cy(init_cluster=1,target_cluster=0,
                                    ...
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)   
    # C3 loading Out1_1 from C1
    emit_str += emit_Cx_load_from_Cy(init_cluster=3,target_cluster=1,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs) 
    # C2 Loading In4 from C0
    emit_str += emit_Cx_load_from_Cy(init_cluster=2,target_cluster=0,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
    ...
    emit_str += emit_Cx_load_from_Cy(init_cluster=1,target_cluster=0,
                                    ...
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)       
    # C3 loading Out1_2 from C1
    emit_str += emit_Cx_load_from_Cy(init_cluster=3,target_cluster=1,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
                        
    # C2 Loading In5 from C0
    emit_str += emit_Cx_load_from_Cy(init_cluster=2,target_cluster=0,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
    # C2 Loading out2_0 from C3
    emit_str += emit_Cx_load_from_Cy(init_cluster=2,target_cluster=3,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
    ...
    emit_str += emit_Cx_load_from_Cy(init_cluster=1,target_cluster=0,
                                    ...
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs) 
    # C3 loading Out1_3 from C1
    emit_str += emit_Cx_load_from_Cy(init_cluster=3,target_cluster=1,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)                                         
    # C2 Loading out2_1 from C3
    emit_str += emit_Cx_load_from_Cy(init_cluster=2,target_cluster=3,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
    ...
    # T8
    # C3 loading Out1_4 from C1
    emit_str += emit_Cx_load_from_Cy(init_cluster=3,target_cluster=1,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)  
    # C2 Loading out2_2 from C3
    emit_str += emit_Cx_load_from_Cy(init_cluster=2,target_cluster=3,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
    ...
    # T9
    # C3 loading Out1_5 from C1
    emit_str += emit_Cx_load_from_Cy(init_cluster=3,target_cluster=1,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
    # C2 Loading out2_3 from C3
    emit_str += emit_Cx_load_from_Cy(init_cluster=2,target_cluster=3,
                                    matrix="A",
                                    matrix_idx_x=0,matrix_idx_y=0,
                                    addr_map=addr_map,**kwargs)
