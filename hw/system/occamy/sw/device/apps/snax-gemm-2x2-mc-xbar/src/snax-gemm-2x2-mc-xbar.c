...
int main() {
	...
	if((snrt_global_core_idx()>=group3_bound_lower) && (snrt_global_core_idx()<group3_bound_upper)){
		if(snrt_is_dm_core()){
			uint32_t dma_C3_load_A10_from_C0_start = mcycle();
			snrt_dma_start_1d(local_a_3, *local_a_C0_3 + 1 * 2048, 8 * 8 * sizeof(int8_t));
			snrt_dma_wait_all();
			uint32_t dma_C3_load_A10_from_C0_end = mcycle();
		}
	}
	...
	if((snrt_global_core_idx()>=group3_bound_lower) && (snrt_global_core_idx()<group3_bound_upper)){
		if(snrt_is_dm_core()){
			uint32_t dma_C3_load_A11_from_C0_start = mcycle();
			snrt_dma_start_1d(local_a_3 + 1 * 256, *local_a_C0_3 + 1 * 256 + 1 * 2048, 8 * 8 * sizeof(int8_t));
			snrt_dma_wait_all();
			uint32_t dma_C3_load_A11_from_C0_end = mcycle();
		}
	}
	...
	if((snrt_global_core_idx()>=group3_bound_lower) && (snrt_global_core_idx()<group3_bound_upper)){
		if(snrt_is_dm_core()){
			uint32_t dma_C3_load_B01_from_C0_start = mcycle();
			snrt_dma_start_1d(local_b_3, *local_b_C0_3 + 1 * 2048, 8 * 8 * sizeof(int8_t));
			snrt_dma_wait_all();
			uint32_t dma_C3_load_B01_from_C0_end = mcycle();
		}
	}
	...
	if((snrt_global_core_idx()>=group3_bound_lower) && (snrt_global_core_idx()<group3_bound_upper)){
		if(snrt_is_dm_core()){
			uint32_t dma_C3_load_B11_from_C0_start = mcycle();
			snrt_dma_start_1d(local_b_3 + 1 * 256, *local_b_C0_3 + 1 * 256 + 1 * 2048, 8 * 8 * sizeof(int8_t));
			snrt_dma_wait_all();
			uint32_t dma_C3_load_B11_from_C0_end = mcycle();
		}
	}
