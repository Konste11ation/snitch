...
//+----------+------------+------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
	...
	if((snrt_global_core_idx()>=group3_bound_lower) && (snrt_global_core_idx()<group3_bound_upper)){
		if(snrt_is_dm_core()){
			uint32_t dma_C3_load_A00_from_C0_start = mcycle();
			snrt_dma_start_2d(local_a_3, *local_a_C0_3, 8 * 8 * sizeof(int8_t), 1024, 1024, 32);
			snrt_dma_wait_all();
			uint32_t dma_C3_load_A00_from_C0_end = mcycle();
		}
	}
	...
	if((snrt_global_core_idx()>=group2_bound_lower) && (snrt_global_core_idx()<group2_bound_upper)){
		if(snrt_is_dm_core()){
			uint32_t dma_C2_load_A00_from_C1_start = mcycle();
			snrt_dma_start_2d(local_a_2, *local_a_C1_2, 8 * 8 * sizeof(int8_t), 1024, 1024, 32);
			snrt_dma_wait_all();
			uint32_t dma_C2_load_A00_from_C1_end = mcycle();
		}
	}
	...
	if((snrt_global_core_idx()>=group3_bound_lower) && (snrt_global_core_idx()<group3_bound_upper)){
		if(snrt_is_dm_core()){
			uint32_t dma_C3_load_A00_from_C2_start = mcycle();
			snrt_dma_start_2d(local_a_3, *local_a_C2_3, 8 * 8 * sizeof(int8_t), 1024, 1024, 32);
			snrt_dma_wait_all();
			uint32_t dma_C3_load_A00_from_C2_end = mcycle();
		}
	}
