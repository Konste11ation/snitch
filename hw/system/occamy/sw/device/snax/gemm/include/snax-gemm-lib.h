...
// Get the delta addr for a
// with block idx b,m, and k
uint32_t get_delta_addr_a(uint8_t b,
                          uint8_t m, uint8_t k,
                          uint32_t strideInnermostA,
                          uint32_t ldA,
                          uint32_t strideA);
// Get the delta addr for b
// with block idx b,n, and k                          
...
// Load a block of input matrix A from L3 to TCDM
// with block idx b, m and k
void load_input_A_block(uint8_t b,
                        ...
                        uint32_t ldA, 
                        uint32_t strideA);
// Load a block of input matrix B from L3 to TCDM
...
void load_input_B_block(uint8_t b,
                        ...
                        uint32_t ldB, 
                        uint32_t strideB);
// Load input matrix A from L3 to TCDM
...
// Load input matrix B from L3 to TCDM
